...
char_position = input("Введите номер символа, который хотите вывести: ")

start_char_position = ALPHABET_RUS.find(start_char.lower()) + 1
end_char_position = ALPHABET_RUS.find(end_char.lower()) + 1

char_position = int(char_position) - 1
index_char_position = ALPHABET_RUS[char_position]
...
print(f"Символ по данному индексу: {index_char_position}")
